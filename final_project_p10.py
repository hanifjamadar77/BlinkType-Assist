...
# Load sounds
sound = pyglet.media.load(r"D:\pthon\BlinkType Assist\SOUNDS\sound.wav", streaming=False)
left_sound = pyglet.media.load(r"D:\pthon\BlinkType Assist\SOUNDS\left.wav", streaming=False)
right_sound = pyglet.media.load(r"D:\pthon\BlinkType Assist\SOUNDS\right.wav", streaming=False)
...
predictor = dlib.shape_predictor("D:\pthon\BlinkType Assist\shape.dat\shape_predictor_68_face_landmarks.dat")
